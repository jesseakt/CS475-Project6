...
#define GLOBAL_SIZE_FACTOR      1024*1024
#endif
...
const char *			CL_FILE_NAME = { "project6a.cl" };
...
main( int argc, char *argv[ ] )
{
	...
	fprintf( stderr, "%8d\t%4d\t%10d\t%10.3lf GigaMultsPerSecond\n",
		GLOBAL_SIZE_FACTOR, LOCAL_SIZE, NUM_WORK_GROUPS, (double)NUM_ELEMENTS/(time1-time0)/1000000000. );
